            ...
            <section id="contact" class="scroll-mt-28 mb-20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
                    ...
                    <div class="lg:col-span-2 flex flex-col justify-center pt-2">
                        <h3 class="text-xl font-bold text-fg mb-3">Have an Idea for a Project?</h3>
                        <p class="text-muted text-sm leading-relaxed mb-6">
                            I'm always open to discussing new projects, creative ideas, or opportunities to collaborate. Don't hesitate to send me a message, and I'll get back to you as soon as possible!
                        </p>
                    </div>
